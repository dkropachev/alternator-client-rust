...
pub(crate) struct AlternatorExtensions {
    ...
    pub(crate) behavior_version_set: bool,
...
impl AlternatorConfig {
    ...
    pub(crate) fn has_behavior_version(&self) -> bool {
        self.alternator_ext.behavior_version_set
    }
...
impl AlternatorBuilder {
    ...
    pub fn set_behavior_version(
        ...
        self.alternator_ext.behavior_version_set = behavior_version.is_some();
        self.dynamodb_builder.set_behavior_version(behavior_version);
        self
    }

    pub fn behavior_version_latest(mut self) -> Self {
        self.alternator_ext.behavior_version_set = true;
